...
// Слой widgets: блок "Ваш отзыв о партнёре" на экране прошедшего интервью. Единственный
// блок экрана с реальными данными: отзыв запрашивается у бэка на клиенте (access-токен
// живёт только в памяти браузера), остальной экран - моки.
